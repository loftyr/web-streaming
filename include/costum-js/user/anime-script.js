...
function draw_data(result){
    ...
    for (index in result){
        ...
        var div = '<div class="card-list mb-3 animated zoomIn delay-0'+delay+'s">';
        ...
        div    += '<p class="pt-2 mb-0 pb-0 alur">'+result[index].alur_cerita.substr(0, 200)+'. . . <a href="" class="detail">Detail -></a></p>';
